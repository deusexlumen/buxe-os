...
$script:AdventureWorldMessages = @{
    ...
    armory_desc        = "Die Waffenkammer. Laser-Gewehre hängen ordentlich an der Wand, Stun-Stäbe daneben. Eine verschlossene Tür führt zu einem Nebenraum, in dem garantiert nichts Gutes wartet. Im Westen zurück in den Korridor. Auf dem Tisch liegt eine Notiz mit einem Code – sehr original, Leveldesigner."
    quarters_desc      = "Die Crew-Quarters. Kleine Kabinen, ein Gemeinschaftsraum. Jemand hat hier gelebt, geliebt, gefürchtet. Ein Tagebuch liegt auf einem Bett und flüstert 'lies mich'. Im Osten geht es zurück in den Korridor. Captain Vance' Bett ist gemacht. Verdächtig."
    ...
    cafeteria_desc     = "Die Cafeteria. Tische, Stühle, ein Automat, der leise vor sich hin summt. Vergessene Tassen stehen herum wie verwaiste Prozesse. Ein Schild wirbt für 'Weltraum-Hähnchen'. Im Westen geht es zurück in den Korridor."
